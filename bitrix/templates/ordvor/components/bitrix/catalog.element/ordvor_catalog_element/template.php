...
<div class="bx-catalog-element product-detail product-detail product-detail js-product-item-d bx-<?=$arParams['TEMPLATE_THEME']?>" id="<?=$itemIds['ID']?>"
	...
	<div class="container-fluid container-fluid-element">
				...
				<div class="col-xs-12">
        			...
        			if($arResult['SHOW_18_04_MESSAGE']) {
    				    ...
    				    <div class="product-notice-info" style="margin-top: 0;background:#f7b3ae;font-size:16px;color:#000">
							...
							только по предварительной записи по телефонам: <nobr><a style="color:#000" href="tel:89626763099">+7 (962) 676-30-99</a>,</nobr> <nobr><a style="color:#000" href="tel:89098436629">+7(909) 843-66-29</a>,</nobr> <nobr><a style="color:#000" href="tel:89098015487">+7(909) 801-54-87</a></nobr></div>
    				    <?php 
    				}
    			    ?>
				</div>
		...
		<div class="row">
        	...
        	<a href="#tab-review" class="evaluate">Оценить</a>
			...
			<div class="col-md-4 col-sm-12">
				<div class="row">
					...
					<div class="col-sm-12">
								...
								switch ($blockName)
								{
									...
									*/
									...
									case 'price':
										if ($arResult["PROPERTIES"]["NE_DLYA_PRODAZHI"]["VALUE"] != "false")
										{
											echo "Товар доступен только в оффлайн-магазинах";
										}
											...
											<div class="product-item-detail-info-container">
												...
												if ($arParams['SHOW_OLD_PRICE'] === 'Y')
												{
													...
													<div class="product-item-detail-price-old" id="<?=$itemIds['OLD_PRICE_ID']?>"
														style="display: <?=($showDiscount ? '' : 'none')?>; <?php if ($arResult["PROPERTIES"]["NE_DLYA_PRODAZHI"]["VALUE"] != "false") echo "none"; ?>">
												...
												<?php if ($arResult["PROPERTIES"]["NE_DLYA_PRODAZHI"]["VALUE"] != "false") echo "style='display: none;'"; ?>
												>
													...
													<div class="product-item-detail-info-container catalog-buy">
														<a class="btn <?=$showButtonClassName?> product-item-detail-buy-button" id="<?=$itemIds['ADD_BASKET_LINK']?>"
															...
															<span class="btn-caption">
                                        						<span class="icon-site icon-basket2"></span>Добавить в корзину
                                    						</span> 
														</a>
													</div>
													<?
											...
											<label id="<?=$itemIds['COMPARE_LINK']?>">
												...
												<span data-entity="compare-title"><?/*=$arParams['MESS_BTN_COMPARE']*/?>
													<div class="compare js-compare-d">
							                            <span class="icon-site icon-compare" data-entity="icon-compare"><span class="compare-text">Сравнить</span></span>
							                        </div>
												</span>
											</label>
										</div>
						...
						<a href="/pokupai-v-rassrochku/" target="_blank"><img src="<?=SITE_TEMPLATE_PATH;?>/img/sber2.jpg" style="max-width: 100%;margin-bottom: 15px;"/></a>
