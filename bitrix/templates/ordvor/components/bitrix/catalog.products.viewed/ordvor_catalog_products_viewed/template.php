...
<div class="catalog-products-viewed bx-<?=$arParams['TEMPLATE_THEME']?>" data-entity="<?=$containerName?>">
	...
	if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS']))
	{
		...
		?>
							...
							<div class='row viewed-products-row'>
						<div class='col-xs-12 viewed-products' data-entity="parent-container">
		
									<div class="sect-header">
				                <div class="sect-title">Вы недавно смотрели:</div>
				            </div>
		...
		<?php 
		/*
		  если вариант = 3  тогда подрубаем карусель. В конце цикла - условия под закрывающие теги. До захода в форыч берем вариант из $arResult
		*/
		?>
		<?php if($arResult['ITEM_ROWS'][0]['VARIANT'] == 3){?>
			<div class="row <?=$arResult['ITEM_ROWS'][0]['CLASS']?>" data-entity="items-row">
				<div class="product-item-small-card owl-carousel owl-carousel-viewed-products">
		<?php }?>
		<?
