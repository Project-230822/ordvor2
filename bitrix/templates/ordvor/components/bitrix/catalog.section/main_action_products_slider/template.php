...
<div class="product-block product-block-actions ">

	<div class="sect-header">

		<div class='sect-title'>Акции</div>

		<div class="all-link">
			<a href='/actions/' title='Все акции'>Все акции</a>
		</div>
		...
		<ul class="items-list owl-carousel owl-carousel-action-products">
			<?
				...
				foreach ($arResult['ITEM_ROWS'] as $rowData)
				{
					...
					?>
						...
						switch ($rowData['VARIANT'])
						{
							case 0:
								?>
								<li class="item main-new-products-slider-item">
									<?
									$item = reset($rowItems);
									$APPLICATION->IncludeComponent(
										'bitrix:catalog.item',
										'main_action_products_slider_item',
										array(
											'RESULT' => array(
												'ITEM' => $item,
