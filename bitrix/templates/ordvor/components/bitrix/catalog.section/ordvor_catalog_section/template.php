...
//echo "<pre>"; var_dump($arResult['ITEMS'][0]['DETAIL_PAGE_URL']); echo "</pre>";
    		...
    		<div class="chosen-container chosen-container-single sorttype" title="" id="catalog_sort_type_chosen">
    			...
    			<div class="chosen-drop">
    				...
    				<ul class="chosen-results">
    					<a href="<?=$APPLICATION->GetCurPageParam('sort=SCALED_PRICE_1&order=asc', array("sort", "order"))?>"><li class="active-result <?=$sort1?>">возрастанию цены</li></a>
    					<a href="<?=$APPLICATION->GetCurPageParam('sort=SCALED_PRICE_1&order=desc', array("sort", "order"))?>"><li class="active-result <?=$sort2?>">убыванию цены</li></a>
    					<a href="<?=$APPLICATION->GetCurPageParam('sort=NAME&order=asc', array("sort", "order"))?>"><li class="active-result <?=$sort3?>">названию</li></a>
    					<a href="<?=$APPLICATION->GetCurPageParam('sort=DATE_CREATE&order=asc', array("sort", "order"))?>"><li class="active-result <?=$sort4?>">дате поступления</li></a>
    					<a href="<?=$APPLICATION->GetCurPageParam('sort=SHOWS&order=asc', array("sort", "order"))?>"><li class="active-result <?=$sort5?>">популярности</li></a>
    				</ul>
    			</div>
    		</div>
    	</div>	
    ...
    <div class="catalog-product-count">
		...
		<div class="chosen-container chosen-container-single product-count" style="width: 80px;" title="" id="catalog_sort_prior_chosen">
			...
			<div class="chosen-drop">
				...
				<ul class="chosen-results">
					<a href="<?=$APPLICATION->GetCurPageParam('PAGE_ELEMENT_COUNT=30', array("PAGE_ELEMENT_COUNT"))?>"><li class="active-result <?=$count30?>">30</li></a>
					<a href="<?=$APPLICATION->GetCurPageParam('PAGE_ELEMENT_COUNT=60', array("PAGE_ELEMENT_COUNT"))?>"><li class="active-result <?=$count60?>">60</li></a>
					<a href="<?=$APPLICATION->GetCurPageParam('PAGE_ELEMENT_COUNT=90', array("PAGE_ELEMENT_COUNT"))?>"><li class="active-result <?=$count90?>">90</li></a>
					<a href="<?=$APPLICATION->GetCurPageParam('PAGE_ELEMENT_COUNT=120', array("PAGE_ELEMENT_COUNT"))?>"><li class="active-result <?=$count120?>">120</li></a>
				</ul>
			</div>
		</div>
	</div>
...
<?=$GLOBALS['FILTER_PARAMS_ACTIVE_TEXT']?>


<?
global $arrBannerFilter;
$SECTION_FILTER_ID = $arResult['VARIABLES']['SECTION_ID']?:$arResult['ID'];
$arrBannerFilter = array('PROPERTY_SECTIONS_ID' => $SECTION_FILTER_ID);
...
<div class="catalog-section bx-<?=$arParams['TEMPLATE_THEME']?>" data-entity="<?=$containerName?>">
										...
										<div class="col-md-12">
											...
											$APPLICATION->IncludeComponent(
												...
												array(
													...
													"LIST_OF_NEW_PRODUCTS" => $arParams["LIST_OF_NEW_PRODUCTS"],
												),
												$component,
												array('HIDE_ICONS' => 'Y')
											);
								...
								foreach ($rowItems as $item)
								{
									...
									<div class="col-sm-4 col-xs-6 product-item-big-card">
										<div class="row">
											<div class="col-md-12">
												<?
												//echo "<pre>"; var_dump($item['DETAIL_PAGE_URL']); echo "</pre>";
	...
	else
	{
		echo "
		<div class='col-xs-12'>
			<h3>Выбранных товаров нет в наличии</h3>
		</div>
		";		
		/*
...
if ($showLazyLoad)
{
	...
	<div class="row bx-<?=$arParams['TEMPLATE_THEME']?>">
		<div class='col-xs-12'>
			<div class="btn btn-default btn-lg center-block show-more-button"
...
<?$this->SetViewTarget('category_desc');?>
<?php 
 // Переносим в component_epilog.php
