...
{
	$title = "Купить " . $arResult["NAME"] . $arResult["FILTER_MANUFACTURER_NAMES"] . " по доступной цене в {{city|предложный}}. " . $arResult["FILTER_PROPS"];
	$description = "Доступная цена на " . $arResult["NAME"] . $arResult["FILTER_MANUFACTURER_NAMES"] . " в интернет магазине Оружейный двор. Купите " . $arResult["NAME"] . " с доставкой в {{city|предложный}}"  . "." . $arResult["FILTER_PROPS"];
}
...
elseif ($arResult["NAME"])
{
	...
	$title = "Купить " . $arResult["NAME"] . " по низкой цене в {{city|предложный}}";
	$description = "Доступная цена на " . $arResult["NAME"] . " в интернет магазине Оружейный двор. Купите " . $arResult["NAME"] . " с доставкой ";
}
