...
$smartPreFilter[">PROPERTY_PROTSENT_SKIDKI"] = "0";
...
if ($isFilter || $isSidebar): ?>
	...
	<div class="catalog-filters col-md-3 col-sm-4 <?=(isset($arParams['FILTER_HIDE_ON_MOBILE']) && $arParams['FILTER_HIDE_ON_MOBILE'] === 'Y' ? ' hidden-xs' : '')?>">
		<? if ($isFilter): ?>
			...
			<?php //if($USER->isAdmin()) {?>
				<?php $APPLICATION->ShowViewContent('sale_section_list'); ?>
			<?php //} else {?>
...
<div class="<?=(($isFilter || $isSidebar) ? "col-md-9 col-sm-12" : "col-xs-12")?>">
	<div class="row">
		<div class="col-xs-12">
			...
			<div class="col-xs-12">
				<p>В интернет-гипермаркете SHOP.ORDVOR.RU можно приобрести товары для охоты, туризма, спорта, активного отдыха и отдыха на природе со скидками. Мы проводим регулярные акции, на часть ассортимента распространяется распродажа. Внимательно следите за обновлениями в разделе, новостями магазина. При необходимости, запрашивайте нужную информацию о скидках у менеджеров интернет-магазина. Сортировать товары в разделе можно либо по брендам, либо по группам товаров.</p>
				<br>
			</div>
			<?
...
*/
			...
			{
				$arrFilter[">PROPERTY_PROTSENT_SKIDKI"] != '';
			}
			
			$intSectionID = $APPLICATION->IncludeComponent(
				"bitrix:catalog.section",
				"ordvor_sale_catalog_section",
				array(
					"IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
					"IBLOCK_ID" => $arParams["IBLOCK_ID"],
