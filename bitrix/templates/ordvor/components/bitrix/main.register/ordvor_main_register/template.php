...
<table>
	<thead>
		<tr>
			<td colspan="2"><h1 class="page-title"><?=GetMessage("AUTH_REGISTER")?></h1></td>
		</tr>
	</thead>
	<tbody>
...
<?
		...
		default:
			...
			?>
			<?php if ($FIELD == "PERSONAL_PHONE"): ?>
				<input size="30" type="text" name="REGISTER[<?=$FIELD?>]" class="registration-phone" value="" />
			<?php else: ?>
