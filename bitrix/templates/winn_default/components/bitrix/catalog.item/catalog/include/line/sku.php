...
<div data-entity="sku-line-block">
	...
	{
		?>
		<div class="product-info-container-title mb-2 text-extra"><?=htmlspecialcharsEx($skuProperty['NAME'])?>: <span class="text-body" data-entity="sku-current-value"></span></div>
		<div class="product-scu-block">
			<div class="product-scu-list">
			<?php
			...
			{
				?>
				<ul class="product-scu-item-list">
					<?
	...
	{
		?>
		<span class="product-info-container-title text-extra py-2 align-middle"><?=htmlspecialcharsEx($skuProperty['NAME'])?>:</span>
		<span class="product-scu-block">
			<span class="product-scu-list">
				<ul class="product-scu-item-list list-inline d-inline">
					<?
					foreach ($skuProperty['VALUES'] as $value)
					{
						if (!isset($item['SKU_TREE_VALUES'][$propertyId][$value['ID']]))
