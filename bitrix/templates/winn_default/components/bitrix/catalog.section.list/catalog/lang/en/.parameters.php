...
$MESS['RS_WINN_UNDEFINED'] = 'Not specified';
$MESS["RS_WINN_PREVIEW_TRUNCATE_LEN"] = "Maximum preview text length (for Text type only)";
$MESS["RS_WINN_SHOW_PARENT_DESCR"] = "Show section description";
$MESS["RS_WINN_PARENT_URL"] = "Parent url";
?>