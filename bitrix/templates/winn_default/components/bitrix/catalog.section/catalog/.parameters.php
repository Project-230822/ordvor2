...
if (isset($arCurrentValues['USE_OWL']) && $arCurrentValues['USE_OWL'] == 'N')
{
...
// {
	// $arProductBlocks['rate'] = GetMessage('RS_WINN_PRODUCT_BLOCK_RATE');
// }
...
$arTemplateParameters['FILTER_PROPS'] = array(
	...
	'NAME' => getMessage('RS_WINN_BCS_CATALOG_FILTER_PROPS'),
	'TYPE' => 'LIST',
	'VALUES' => array_merge(
		$defaultValue,
		$arListPropList//,
...
$arTemplateParameters['SHOW_OLD_PRICE'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage('RS_WINN_SHOW_OLD_PRICE'),
	'TYPE' => 'CHECKBOX',
	'DEFAULT' => 'N'
);
/*
...
$arTemplateParameters['TEMPLATE_VIEW'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage('RS_WINN_TEMPLATE_VIEW'),
	'TYPE' => 'LIST',
	'MULTIPLE' => 'N',
...
$arTemplateParameters['BACKGROUND_COLOR'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage('RS_WINN_BACKGROUND_COLOR'),
	'TYPE' => 'LIST',
	'MULTIPLE' => 'N',
	'DEFAULT' => '-',
	'ADDITIONAL_VALUES' => 'Y',
...
$arTemplateParameters['USE_VOTE_RATING'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage('RS_WINN_USE_VOTE_RATING'),
	'TYPE' => 'CHECKBOX',
	'DEFAULT' => 'N',
	'REFRESH' => 'Y'
);
...
if (isset($arCurrentValues['USE_VOTE_RATING']) && 'Y' == $arCurrentValues['USE_VOTE_RATING'])
{
	$arTemplateParameters['VOTE_DISPLAY_AS_RATING'] = array(
		'PARENT' => 'VISUAL',
		'NAME' => GetMessage('RS_WINN_VOTE_DISPLAY_AS_RATING'),
		'TYPE' => 'LIST',
		'VALUES' => array(
			'rating' => GetMessage('RS_WINN_DVDAR_RATING'),
			'vote_avg' => GetMessage('RS_WINN_DVDAR_AVERAGE'),
		),
		'DEFAULT' => 'rating'
	);
