...
$APPLICATION->AddChainItem(Loc::getMessage('RS_WINN_BC_CATALOG_COMPARE_TITLE'), $APPLICATION->GetCurPage());
$APPLICATION->SetTitle(Loc::getMessage('RS_WINN_BC_CATALOG_COMPARE_TITLE'));
