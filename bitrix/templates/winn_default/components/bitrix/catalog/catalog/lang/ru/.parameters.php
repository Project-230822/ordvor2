...
$MESS["ADD_TO_BASKET_ACTION_FEEDBACK"] = "отправить форму";
...
$MESS["RS_WINN_CATALOG_VIEW_MODE"] = "Вид отображения каталога";
$MESS["RS_WINN_CATALOG_VIEW_MODE_SECTIONS"] = "Отображать разделы";
$MESS["RS_WINN_CATALOG_VIEW_MODE_ELEMENTS"] = "Отображать товары";
$MESS["RS_WINN_SHOW_SECTION_DESCRIPTION"] = "Показывать описание раздела";
$MESS["RS_WINN_SHOW_SECTION_DESCRIPTION_TOP"] = "Сверху";
$MESS["RS_WINN_SHOW_SECTION_DESCRIPTION_BOTTOM"] = "Снизу";
...
$MESS["RS_WINN_USE_BRANDS"] = "Использовать Бренды";
...
$MESS["RS_WINN_DETAIL_TEXT"] = "описание";
$MESS["RS_WINN_DETAIL_PROPERTIES"] = "характеристики";
$MESS["RS_WINN_DETAIL_COMMENTS"] = "отзывы";
$MESS["RS_WINN_DETAIL_STOCK"] = "склады";
$MESS["RS_WINN_DETAIL_SET"] = "набор";
$MESS["RS_WINN_DETAIL_GIFTS"] = "Подарки";
$MESS["RS_WINN_DETAIL_GIFT_MAIN"] = "Товары к подарку";
$MESS["RS_WINN_LIST_USE_PRODUCT_QUANTITY"] = "Выводить поле указания количества товара в списке";
$MESS["RS_WINN_DETAIL_USE_PRODUCT_QUANTITY"] = "Выводить поле указания количества товара на детальной странице";
$MESS["RS_WINN_LIST_PRODUCT_BLOCKS"] = "Отображаемые блоки товара";
$MESS["RS_WINN_DETAIL_PRODUCT_INFO_BLOCK"] = "Блоки информации о товаре";
$MESS["RS_WINN_DETAIL_PRODUCT_INFO_BLOCK_COMPARE_FAVORITE"] = "Сравнение\nИзбранное";
$MESS["RS_WINN_DETAIL_PRODUCT_INFO_BLOCK_ID_RATE_STOCK_BRAND"] = "Артикул\nРейтинг\nНаличие\nБренд";
$MESS["RS_WINN_DETAIL_PRODUCT_INFO_BLOCK_CHEAPER"] = "Дешевле";
$MESS["RS_WINN_DETAIL_PRODUCT_INFO_BLOCK_PRODUCT_DEALS"] = "Акции";
$MESS["RS_WINN_DETAIL_PRODUCT_INFO_BLOCK_DELIVERY_INFO"] = "Информация о доставке";
$MESS["RS_WINN_DETAIL_PRODUCT_INFO_BLOCK_BRANDBLOCK"] = "Иконки";
$MESS["RS_WINN_DETAIL_TAB_PROPERTIES"] = "Добавить свойства к списку вкладок";
$MESS["RS_WINN_DETAIL_TABS"] = "Вкладки";
$MESS["RS_WINN_DETAIL_TABS_ORDER"] = "Порядок отображения вкладок";
$MESS["RS_WINN_DETAIL_BLOCK_LINES_PROPERTIES"] = "Добавить свойства в ленту";
$MESS["RS_WINN_DETAIL_BLOCK_LINES"] = "Лента";
$MESS["RS_WINN_DETAIL_BLOCK_LINES_ORDER"] = "Порядок отображения ленты";
$MESS["RS_WINN_SIDEBAR_OUTER_SECTIONS_SHOW"] = "Показывать сайдбар (слева)";
$MESS["RS_WINN_SIDEBAR_INNER_SECTIONS_SHOW"] = "Показывать сайдбар (справа)";
$MESS["RS_WINN_SIDEBAR_OUTER_SECTION_SHOW"] = "Показывать сайдбар (слева)";
$MESS["RS_WINN_SIDEBAR_INNER_SECTION_SHOW"] = "Показывать сайдбар (справа)";
$MESS["RS_WINN_SIDEBAR_OUTER_DETAIL_SHOW"] = "Показывать сайдбар (слева)";
$MESS["RS_WINN_SIDEBAR_INNER_DETAIL_SHOW"] = "Показывать сайдбар (справа)";
$MESS["RS_WINN_SIDEBAR_OUTER_PATH"] = "Путь к включаемой области для вывода информации в левом блоке";
$MESS["RS_WINN_SIDEBAR_INNER_PATH"] = "Путь к включаемой области для вывода информации в правом блоке";
$MESS["RS_WINN_IBLOCK_ID_LANDING"] = "Инфоблок с блоками для лендинга";
$MESS["RS_WINN_PROPERTY_LANDING"] = "Выводимые свойства у лендингов";
$MESS["RS_WINN_LANDING_LINK"] = "Свойство с привязкой к разделу (лендингу)";
...
$MESS["RS_WINN_FILTER_THEME"] = "Цветовая тема";
$MESS["RS_WINN_FILTER_SCROLL_PROPS"] = "Скролл для (свойство каталога)";
$MESS["FILTER_SCROLL_PROPS_TIP"] = "Свойства, в которых используется скролл";
$MESS["RS_WINN_FILTER_SEARCH_PROPS"] = "Поиск для (свойство каталога)";
$MESS["FILTER_SEARCH_PROPS_TIP"] = "Свойства, в которых используется поиск";
$MESS["RS_WINN_OFFER_FILTER_SCROLL_PROPS"] = "Скролл для(свойство ТП)";
$MESS["OFFER_FILTER_SCROLL_PROPS_TIP"] = "Свойства торговых предложений, в которых используется скролл";
$MESS["RS_WINN_OFFER_FILTER_SEARCH_PROPS"] = "Поиск для(свойство ТП)";
$MESS["OFFER_FILTER_SEARCH_PROPS_TIP"] = "Свойства торговых предложений, в которых используется скролл";
$MESS["RS_WINN_FILTER_FIXED"] = "Использовать закрепление фильтра";
$MESS["RS_WINN_FILTER_COLLAPSE_ACTIVE"] = "Скрывать фильтр при загрузке страницы на мобильных устройствах";
$MESS["RS_WINN_INSTANT_RELOAD"] = "Использовать AJAX при фильтрации";
$MESS["RS_WINN_FILTER_TOP_PROPS"] = "Избранные фильтры";
$MESS["RS_WINN_FEATURE_FILTER_USER_FIELDS"] = "Feature-фильтры (польз. свойство)";
$MESS["RS_WINN_PRODUCT_DEALS_SHOW"] = "Показывать акции";
$MESS["RS_WINN_PRODUCT_DEALS_USER_FIELDS"] = "Товар участвует в акциях (польз. свойство)";
$MESS["RS_WINN_LIST_BACKGROUND_COLOR"] = "Цвет фона (польз. свойство)";
$MESS["RS_WINN_DETAIL_BACKGROUND_COLOR"] = "Цвет фона (свойство ИБ)";
$MESS["RS_WINN_OFFER_TREE_DROPDOWN_PROPS"] = "Свойства для отбора предложений (выпадающий список)";
$MESS['RS_WINN_OFFER_TREE_SIZE_PROPS'] = "Свойства для отбора предложений (тип размер)";
...
$MESS["RS_WINN_PROPERTY_FILE_VIEW"] = "Внешний вид #NAME#";
$MESS["RS_WINN_PROPERTY_FILE_VIEW_COL"] = "колонки";
$MESS["RS_WINN_PROPERTY_FILE_VIEW_LINE"] = "полоски";
$MESS["RS_WINN_PROPERTY_FILE_VIEW_IMAGE_COL"] = "галерея(колонки)";
$MESS["RS_WINN_PROPERTY_FILE_VIEW_IMAGE_LINE"] = "галерея(полоски)";
$MESS["RS_WINN_PROPERTY_ELEMENT_LINE_COUNT"] = "Количество элементов для отображения во вкладке";
$MESS["RS_WINN_VIEWED_SECTION_LIST_PAGE_ELEMENT_COUNT"] = "Количество элементов в блоке \"Вы смотрели\" строке в списке";
$MESS["RS_WINN_USE_WIDGET_PARAMETERS"] = "Использовать конфигурации из виджета настройки сайта";
$MESS["RS_WINN_LIST_SHOW_ROWS"] = "Количество рядов с элементами на странице";
// detail delivery
$MESS["RS_WINN_DETAIL_DELIVERY_PAYMENT_INFO"] = "Показывать ссылки на страницы оплаты и доставки";
$MESS["RS_WINN_DETAIL_DELIVERY_LINK"] = "Ссылка на страницу доставки";
$MESS["RS_WINN_DETAIL_PAYMENT_LINK"] = "Ссылка на страницу оплаты";
$MESS["RS_WINN_SHOW_SECTIONS_LIST"] = "Показывать список разделов";
// catalog.sorter
$MESS["RS_WINN_USE_SORTER"] = "Показывать блок сортировки";
$MESS["RS_WINN_SORTER_TEMPLATE"] = "Шаблон сортировки";
...
$MESS["RS_WINN_BUY_ON_CAN_BUY"] = "Отображать кнопки покупки если товар недоступен";
$MESS["RS_WINN_DETAIL_SHOW_CASHBACK"] = "Показывать количество начисляемых бонусов";
$MESS["RS_WINN_DETAIL_SHOW_SIZE_TABLE"] = "Выводить таблицу размеров";
$MESS["RS_WINN_SIZE_TABLE_USER_FIELDS"] = "Таблица размеров (польз. свойство)";
$MESS["RS_WINN_SIZE_TABLE_PROP"] = "Таблица размеров (свойство ИБ)";
?>
