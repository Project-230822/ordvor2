...
if (!function_exists('getSiteHeadCatalog'))
{
	function getSiteHeadCatalog()
	{
		...
		$sHTML .= '<div class="row"><div class="col-10"><h2 class="mt-0 mb-0 pb-2">'.$APPLICATION->GetTitle(false, false).'</h2></div></div>';
...
?>
<div>
	<?php $APPLICATION->AddBufferContent('getSiteHeadCatalog'); ?>
</div>
...
if ($request->isAjaxRequest())
{
	...
	// CMain::FinalActions();
	?></div><!-- ajax-content-custom --><?php
	// die();
}
?>
<div class="btn btn-outline-secondary mt-5 mb-6 b-news-detail__btn">
	<a class="text-center b-news-detail__btn-link" href="<?=$arResult["FOLDER"].$arResult["URL_TEMPLATES"]["news"]?>"><?=GetMessage("T_NEWS_DETAIL_BACK")?></a>	
</div>
