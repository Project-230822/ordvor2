...
$arTemplateParameters = array(
	...
	'SHOW_INPUT_LABEL' => array(
		'NAME' => GetMessage('TP_BST_SHOW_INPUT_LABEL'),
		'TYPE' => 'CHECKBOX',
		'DEFAULT' => 'Y',
		'REFRESH' => 'Y',
	),
...
if (isset($arCurrentValues['SHOW_INPUT_LABEL']) && 'Y' == $arCurrentValues['SHOW_INPUT_LABEL'])
{
	$arTemplateParameters['INPUT_LABEL_TEXT'] = array(
		'NAME' => GetMessage('TP_BST_INPUT_LABEL_TEXT'),
		'TYPE' => 'STRING',
		'DEFAULT' => GetMessage('TP_BST_INPUT_LABEL_TEXT_DEFAULT'),
	);
}
