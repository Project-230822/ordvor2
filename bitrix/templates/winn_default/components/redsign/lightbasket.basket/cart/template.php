...
?>
<div class="b-cart mb-6" id="<?=$jsParams['ID']?>">
	<?php
	if ($isAjax)
	{
		ob_start();
	...
	{
	?>
		<div class="row px-lg-4 d-none d-xl-flex">
			<div class="col-5">
				<div class="pb-3 b-cart__table-name small"><?=Loc::getMessage('RS_LIGHTBASKET_TABLE_NAME');?></div>
			</div>
			<div class="col-7">
				<div class="row">
					<div class="col-3">
						<div class="b-cart__table-price small"><?=Loc::getMessage('RS_LIGHTBASKET_TABLE_PRICE');?></div>
					</div>
					<div class="col-3">
						<div class="b-cart__table-quantity small pl-5"><?=Loc::getMessage('RS_LIGHTBASKET_TABLE_QUANTITY');?></div>
					</div>
					<div class="col">
						<div class="b-cart__table-sum small"><?=Loc::getMessage('RS_LIGHTBASKET_TABLE_SUM');?></div>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col-12 product-table-card">
					<div class="product product--table border-top border-bottom">
						<div class="row py-4 px-lg-4 align-items-center">
							<div class="d-sm-none d-block position-relative b-cart__tools-remove-on-mobile">
								<a href="<?=$arItem['URL_TO_DELETE']?>" class="">
									<svg class="icon-svg"><use xlink:href="#svg-cross"></use></svg>
								</a>
							</div>
							<div class="col-12 col-xl-5 mb-3 mb-sm-0">
								<div class="row">
									<?php
							...
							<div class="col-12 col-xl-7 mb-3 mb-sm-0">
								<div class="row pt-sm-4 pb-sm-3 align-items-center">
									<div class="col col-sm-auto col-xl-3 position-relative d-none d-sm-block">
...
*/
									...
									<div class="col-auto col-xl-3 position-relative">
									...
									<div class="col-auto position-relative text-right text-xl-left">
										<div class="text-secondary font-size-sm font-weight-bold position-absolute text-nowrap bottom-100 d-xl-none"><?=Loc::getMessage('RS_LIGHTBASKET_TABLE_SUM');?></div>
									...
									<div class="col-auto d-none d-sm-block">
										<a href="<?=$arItem['URL_TO_DELETE']?>" class="d-block b-cart__tools-remove js-cart__remove no-barba">
...
*/
		...
		<div class="b-cart__bottom">
			...
			<a class="btn btn-link pl-0 pl-sm-4 ml-0 ml-sm-4 font-weight-bold" href="<?=$arParams['PATH_TO_CATALOG']?>" class="js-cart-close"><?=Loc::getMessage('RS_LIGHTBASKET_CONTINUE');?></a>
		</div>
		<?php
	}
	else
	...
	{
		?>
		<script>RS.LightbasketCart = new RSLightbasketCart(<?=CUtil::PhpToJSObject ($jsParams)?>);</script>
		<?php
	}
	?>
</div>