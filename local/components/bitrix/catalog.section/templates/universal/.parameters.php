...
if ($iblockExists) {
	...
	// TODO 
	$arTemplateParameters['DISPLAY_PRODUCTS_IN_SLIDER'] = array(
		'PARENT' => 'VISUAL',
		'NAME' => GetMessage('CP_BCS_TPL_DISPLAY_PRODUCTS_IN_SLIDER'),
		'TYPE' => 'CHECKBOX',
		"REFRESH" => 'Y',
		'DEFAULT' => 'N'
	);

	if ($arCurrentValues['DISPLAY_PRODUCTS_IN_SLIDER'] !== "Y") {
		$arTemplateParameters['NUMBER_PRODUCTS_IN_ROW'] = array(
			'PARENT' => 'VISUAL',
			'NAME' => GetMessage('CP_BCS_TPL_NUMBER_PRODUCTS_IN_ROW'),
			'TYPE' => 'LIST',
			'MULTIPLE' => 'N',
			'ADDITIONAL_VALUES' => 'N',
			'DEFAULT' => '-',
...
$arTemplateParameters['HIDE_SORTING'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage('CP_BCS_TPL_HIDE_SORTING'),
	'TYPE' => 'CHECKBOX',
	'DEFAULT' => 'N'
);
