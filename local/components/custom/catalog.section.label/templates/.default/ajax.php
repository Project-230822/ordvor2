...
$filterKey = $request->getPost('filterKey');
$parameters = $request->getPost('parameters');
$componentName = $request->getPost('componentName');

$arParams = \Bitrix\Main\Component\ParameterSigner::unsignParameters($componentName, $parameters);

$GLOBALS["arrFilter"] = ["PROPERTY_LABEL_LIST" => $filterKey];
...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"USE_COMPARE_LIST" => "N",
		'HIDE_SORTING' => 'Y',
		"PARENT_COMPONENT_NAME" => $componentName
	),
	false
);