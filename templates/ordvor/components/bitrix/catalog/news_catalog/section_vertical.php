...
$filterDateCreateTime = time() - (30 * 24 * 60 * 60);

global $arrFilter;
$arrFilter[">=DATE_CREATE"] = date('d.m.Y H:i:s', $filterDateCreateTime);

global $smartPreFilter;
$smartPreFilter[">=DATE_CREATE"] = date('d.m.Y H:i:s', $filterDateCreateTime);
