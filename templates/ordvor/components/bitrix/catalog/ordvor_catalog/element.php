...
$exceptCode = array("vote_count", "vote_sum", "rating", 
		"BLOG_POST_ID", "BLOG_COMMENTS_CNT", "COINT_REVIEWS","SUMM_REVIEWS", 
		"SEARCH_XML_ID", "SEARCH_OFFERS_CODES", "GABARITY_DLINA", 
		"GABARITY_SHIRINA", "GABARITY_VYSOTA", "GABARITY_KOEFFITSIENT_PERESCHETA",
		"GABARITY_VES", "UTOCHNIT_TSENU", "NE_DLYA_PRODAZHI", "PROTSENT_SKIDKI", "CML2_MANUFACTURER"
	);

$dbProps = \Bitrix\Iblock\PropertyTable::getList(array(
	'select' => array('CODE'),
	'filter' => array('IBLOCK_ID' => $arParams['IBLOCK_ID'], "!CODE" => $exceptCode)
));
...
$arParams['DETAIL_PROPERTY_CODE'] = $arProps;
	...
	<div class='<?=($isSidebar ? 'col-md-9 col-sm-8' : 'col-xs-12')?>'>
		...
		*/
		...
		if ($elementId > 0)
		{
			...
			//echo "<pre>"; var_dump($recommendedData); echo "</pre>";
					...
					<div class="col-xs-12 container-slider" data-entity="parent-container" data-lg="4">
						...
						$APPLICATION->IncludeComponent(
							...
							array(
								...
								'PRODUCT_ROW_VARIANTS' => "[{'VARIANT':'0','BIG_DATA':true}, {'VARIANT':'0','BIG_DATA':true}, {'VARIANT':'0','BIG_DATA':true}, {'VARIANT':'0','BIG_DATA':true},{'VARIANT':'0','BIG_DATA':true},
								{'VARIANT':'0','BIG_DATA':true},{'VARIANT':'0','BIG_DATA':true},{'VARIANT':'0','BIG_DATA':true},{'VARIANT':'0','BIG_DATA':true},{'VARIANT':'0','BIG_DATA':true},{'VARIANT':'0','BIG_DATA':true},{'VARIANT':'0','BIG_DATA':true}]",
				...
				)
				{
					?>
							...
							$APPLICATION->IncludeComponent(
								...
								'ordvor_catalog_products_viewed',
								array(
									'IBLOCK_MODE' => 'single',
									'IBLOCK_TYPE' => $arParams['IBLOCK_TYPE'],
									'IBLOCK_ID' => $arParams['IBLOCK_ID'],
