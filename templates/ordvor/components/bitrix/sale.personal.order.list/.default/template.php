						...
						foreach ($order['PAYMENT'] as $payment)
						{
							...
							<div class="row sale-order-list-inner-row">
								...
								<div class="sale-order-list-inner-row-body">
									...
									if($payment["ACTION_FILE"]=="sberbank_pokupay")
									{
									...
									if($needWaitStatus)
									{
									    ?>
    								        <div class="col-md-3 col-sm-4 col-xs-12 sale-order-list-button-container">
    											<span style="color:red;">Ожидайте подтверждения заказа менеджером. После проверки заказа с вами свяжется наш менеджер</span>
    										</div>
								        <?
									}
									elseif ($payment['PAID'] === 'N' && $payment['IS_CASH'] !== 'Y' && $payment['ACTION_FILE'] !== 'cash')
									{
