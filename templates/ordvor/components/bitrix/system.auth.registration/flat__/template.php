...
*/?>
<?
$SHOW_REG_BLOCK = false;
if($APPLICATION->GetCurPage(false)!="/personal/cart/") $SHOW_REG_BLOCK = true;
?>
<?
...
<div class="authWrapper<?=$SHOW_REG_BLOCK?" not-in-cart":"";?>">
    <div class="authTab active">
    <?$APPLICATION->IncludeComponent(
        "bitrix:main.register",
        "ordvor_main_register",
        Array(
            "USER_PROPERTY_NAME" => "",
            "SEF_MODE" => "N",
            ...
            "SET_TITLE" => "N",
            "USER_PROPERTY" => Array(),
            "BACK_URL" => $APPLICATION->GetCurPageParam("", $arParamsToDelete)
        )
    );?>
    </div>
</div>