...
/**/ // Наши стили
$APPLICATION->SetAdditionalCSS($this->GetFolder() . "/custom.css");
...
else
{
	...
	if ($arParams['SHOW_PICKUP_MAP'] === 'Y' || $arParams['SHOW_MAP_IN_PROPS'] === 'Y')
	{
		if ($arParams['PICKUP_MAP_TYPE'] === 'yandex')
		{
			...
			?>
			<script src="<?=$scheme?>://api-maps.yandex.ru/2.1.50/?apikey=73706031-97d0-4cd7-8a4d-b18ac892c9d1&load=package.full&lang=<?=$locale?>"></script>
			<script>
