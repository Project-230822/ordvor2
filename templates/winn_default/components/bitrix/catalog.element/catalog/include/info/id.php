...
{
	?>
	<span class="product__artnum small py-1 px-2" data-entity="sku-prop-<?=$actualItem['PROPERTIES'][$arParams['ARTNUMBER_PROP'][$actualItem['IBLOCK_ID']]]['ID']?>">
		<?php
		echo str_replace(
			'#NUMBER#',
...
{
	?>
	<span class="product__artnum small py-1 px-2">
		<?php
		echo str_replace(
			'#NUMBER#',
