...
?>
<div class="card font-size-sm mb-n1" data-entity="price" data-price-id="<?=$arCatPrice['ID']?>"<?=$showPrice ? '' : ' style="display: none;"'?>>
	<div class="card-header py-3 px-4 mb-n1">
		<?php
		if (strlen($arCatPrice['TITLE']) > 0)
		{
	...
	if ($arParams['USE_PRICE_COUNT'])
	{
		...
		<div class="card-body py-3 px-4"
			...
			<dl class="product--detail__price-ranges list-justified" data-entity="price-ranges-body">
