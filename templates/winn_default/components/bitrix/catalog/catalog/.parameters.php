...
$arSectionDescrValues = array(
	'-' => getMessage('CP_BC_TPL_PROP_EMPTY'),
	'top' => getMessage('RS_WINN_SHOW_SECTION_DESCRIPTION_TOP'),
	'bottom' => getMessage('RS_WINN_SHOW_SECTION_DESCRIPTION_BOTTOM'),
);
...
$arDetailProductInfoBlock = array(
	...
	'preview' => GetMessage('RS_WINN_PRODUCT_BLOCK_PREVIEW'),
	// 'deals' => GetMessage('RS_WINN_DETAIL_PRODUCT_INFO_BLOCK_PRODUCT_DEALS'),
);
/*
if ($boolIsCatalog)
{
...
{
   $arDetailProductInfoBlock['id-rate-stock-brand'] = GetMessage('RS_WINN_DETAIL_PRODUCT_INFO_BLOCK_ID_RATE_STOCK_BRAND');
}

if (Loader::includeModule('sale'))
{
	$arDetailProductInfoBlock['delivery'] = GetMessage('RS_WINN_DETAIL_PRODUCT_INFO_BLOCK_DELIVERY_INFO');
}

if (isset($arCurrentValues['DETAIL_BRAND_USE']) && 'Y' == $arCurrentValues['DETAIL_BRAND_USE'])
{
	$arDetailProductInfoBlock['brandblock'] = GetMessage('RS_WINN_DETAIL_PRODUCT_INFO_BLOCK_BRANDBLOCK');
}
*/
$arDetailTabs = array (
	'detail' => Loc::getMessage('RS_WINN_DETAIL_TEXT'),
	'props' => Loc::getMessage('RS_WINN_DETAIL_PROPERTIES'),
);
...
{
	$arDetailTabs['comments'] = Loc::getMessage('RS_WINN_DETAIL_COMMENTS');
	$arDetailBlockLines['comments'] = Loc::getMessage('RS_WINN_DETAIL_COMMENTS');
}

if ($boolIsCatalog)
{
	$arDetailTabs['set'] = Loc::getMessage('RS_WINN_DETAIL_SET');
	$arDetailBlockLines['set'] = Loc::getMessage('RS_WINN_DETAIL_SET');

	if ($arCurrentValues['USE_GIFTS_DETAIL'] == 'Y' && \Bitrix\Main\ModuleManager::isModuleInstalled('sale'))
	{
		// $arDetailTabs['gift'] = Loc::getMessage('RS_WINN_DETAIL_GIFTS');
		$arDetailBlockLines['gift'] = Loc::getMessage('RS_WINN_DETAIL_GIFTS');
	}

	if ($arCurrentValues['USE_GIFTS_MAIN_PR_SECTION_LIST'] == 'Y' && \Bitrix\Main\ModuleManager::isModuleInstalled('sale'))
	{
		// $arDetailTabs['gift-main'] = Loc::getMessage('RS_WINN_DETAIL_GIFT_MAIN');
		$arDetailBlockLines['gift-main'] = Loc::getMessage('RS_WINN_DETAIL_GIFT_MAIN');
	}
}

if ($arCurrentValues['USE_STORE'] == 'Y')
{
	$arDetailTabs['stock'] = Loc::getMessage('RS_WINN_DETAIL_STOCK');
	$arDetailBlockLines['stock'] = Loc::getMessage('RS_WINN_DETAIL_STOCK');
}
*/
$arTemplateParameters = array(
	...
	'SHOW_SECTION_DESCRIPTION' => array(
		...
		'NAME' => getMessage('RS_WINN_SHOW_SECTION_DESCRIPTION'),
		'TYPE' => 'LIST',
...
/*
	$arTemplateParameters['USE_WIDGET_PARAMETERS'] = array(
		'NAME' => GetMessage('RS_WINN_USE_WIDGET_PARAMETERS'),
		'TYPE' => 'CHECKBOX',
		'DEFAULT' => 'Y',
		'REFRESH' => 'Y'
	);
	...
	if ($boolSKU)
	{
		...
		if (!empty($arCurrentValues['OFFER_TREE_PROPS']))
		{
			...
			$arTemplateParameters['DETAIL_SHOW_SIZE_TABLE'] = array(
				'PARENT' => 'DETAIL_SETTINGS',
				'NAME' => GetMessage('RS_WINN_DETAIL_SHOW_SIZE_TABLE'),
				'TYPE' => 'CHECKBOX',
				'DEFAULT' => 'N',
				'REFRESH' => 'Y'
			);
			...
			if (isset($arCurrentValues['DETAIL_SHOW_SIZE_TABLE']) && $arCurrentValues['DETAIL_SHOW_SIZE_TABLE'] === 'Y')
			{
				$arTemplateParameters['OFFER_TREE_SIZE_PROPS'] = array(
					'PARENT' => 'DETAIL_SETTINGS',
					'NAME' => getMessage('RS_WINN_OFFER_TREE_SIZE_PROPS'),
					'TYPE' => 'LIST',
					'VALUES' => $defaultValue + $selected,
					'MULTIPLE' => 'Y',
					'DEFAULT' => '-',
				...
				$arTemplateParameters['SIZE_TABLE_USER_FIELDS'] = array(
					'PARENT' => 'DETAIL_SETTINGS',
					'NAME' => GetMessage('RS_WINN_SIZE_TABLE_USER_FIELDS'),
					'TYPE' => 'LIST',
					'MULTIPLE' => 'N',
					'DEFAULT' => '-',
					'ADDITIONAL_VALUES' => 'Y',
				...
				$arTemplateParameters['SIZE_TABLE_PROP'] = array(
					'PARENT' => 'DETAIL_SETTINGS',
					'NAME' => Loc::getMessage('RS_WINN_SIZE_TABLE_PROP'),
					'TYPE' => 'LIST',
		...
		if ($arCurrentValues['USE_FILTER'] == 'Y')
		{
			$arTemplateParameters['OFFER_FILTER_SCROLL_PROPS'] = array(
				...
				'NAME' => getMessage('RS_WINN_OFFER_FILTER_SCROLL_PROPS'),
				'TYPE' => 'LIST',
				'VALUES' => $defaultValue + $arAllOfferPropList,
				'MULTIPLE' => 'Y',
				'DEFAULT' => '-',
			...
			$arTemplateParameters['OFFER_FILTER_SEARCH_PROPS'] = array(
				'PARENT' => 'FILTER_SETTINGS',
				'NAME' => getMessage('RS_WINN_OFFER_FILTER_SEARCH_PROPS'),
				'TYPE' => 'LIST',
				'VALUES' => $defaultValue + $arAllOfferPropList,
				'MULTIPLE' => 'Y',
				'DEFAULT' => '-',
...
/*
		$arTemplateParameters['DETAIL_DISPLAY_PROPERTIES_MAX'] = array(
			'PARENT' => 'DETAIL_SETTINGS',
			'NAME' => getMessage('RS_WINN_DISPLAY_PROPERTIES_MAX'),
			'TYPE' => 'STRING',
			'DEFAULT' => '',
...
*/
	...
	$arTemplateParameters['SHOW_ERROR_SECTION_EMPTY'] = array(
		'PARENT' => 'LIST_SETTINGS',
		'NAME' => getMessage('RS_WINN_SHOW_ERROR_SECTION_EMPTY'),
		'TYPE' => 'CHECKBOX',
		'VALUE' => 'Y',
		'DEFAULT' => 'N',
	);
	...
	if ($arCurrentValues['SHOW_ERROR_SECTION_EMPTY'] === 'Y')
	{
		$arTemplateParameters['MESS_ERROR_SECTION_EMPTY'] = array(
			'PARENT' => 'LIST_SETTINGS',
			'NAME' => GetMessage('RS_WINN_MESS_ERROR_SECTION_EMPTY'),
			'TYPE' => 'STRING',
			'DEFAULT' => GetMessage('RS_WINN_MESS_ERROR_SECTION_EMPTY_DEFAULT'),
		);
	}
...
$arTemplateParameters['USE_BRANDS'] = array(
	'PARENT' => 'DATA_SOURCE',
	'NAME' => GetMessage('RS_WINN_USE_BRANDS'),
	'TYPE' => 'CHECKBOX',
	'DEFAULT' => 'N',
	'REFRESH' => 'Y'
);
...
if (isset($arCurrentValues['USE_BRANDS']) && 'Y' == $arCurrentValues['USE_BRANDS'])
{
	$arTemplateParameters['BRAND_PROP'] = array(
		'PARENT' => 'DATA_SOURCE',
		"NAME" => GetMessage('RS_WINN_BRAND_PROP'),
		"TYPE" => "LIST",
	...
	if (isset($arHighloadPropList[$arCurrentValues['BRAND_PROP']]))
	{
		$arTemplateParameters['BRAND_IBLOCK_ID'] = array(
			'PARENT' => 'DATA_SOURCE',
			'NAME' => getMessage('RS_WINN_BRAND_IBLOCK_ID'),
			'TYPE' => 'LIST',
			'VALUES' => $arIBlock,
			'DEFAULT' => '',
			'REFRESH' => 'Y',
		...
		if (intval($arCurrentValues['BRAND_IBLOCK_ID']) > 0)
		{
			...
			$arTemplateParameters['BRAND_IBLOCK_BRAND_PROP'] = array(
				'PARENT' => 'DATA_SOURCE',
				'NAME' => getMessage('RS_WINN_BRAND_IBLOCK_BRAND_PROP'),
				'TYPE' => 'LIST',
...
$arTemplateParameters['DETAIL_PRODUCT_INFO_BLOCK'] = array(
	'PARENT' => 'DETAIL_SETTINGS',
	'NAME' => Loc::getMessage('RS_WINN_DETAIL_PRODUCT_INFO_BLOCK'),
	'TYPE' => 'LIST',
...
*/
	...
	$arTemplateParameters['USE_GIFTS'] = array(
		...
		'NAME' => GetMessage('RS_WINN_USE_GIFTS'),
		'TYPE' => 'CHECKBOX',
		'DEFAULT' => 'Y',
		//'REFRESH' => 'Y',
	);
...
if (in_array('BUY1CLICK', $arCurrentValues['DETAIL_ADD_TO_BASKET_ACTION']))
{
	$arTemplateParameters['MESS_BTN_BUY1CLICK'] = array(
		'PARENT' => 'VISUAL',
		'NAME' => Loc::getMessage('RS_WINN_MESS_BTN_BUY1CLICK'),
		'TYPE' => 'STRING',
		'DEFAULT' => Loc::getMessage('RS_WINN_MESS_BTN_BUY1CLICK_DEFAULT')
	);
}
...
$arTemplateParameters['SIDEBAR_OUTER_SECTIONS_SHOW'] = array(
	'PARENT' => 'SECTIONS_SETTINGS',
	'NAME' => getMessage('RS_WINN_SIDEBAR_OUTER_SECTIONS_SHOW'),
	'TYPE' => 'CHECKBOX',
	'DEFAULT' => 'Y',
	'SORT' => 800
);
...
$arTemplateParameters['SIDEBAR_INNER_SECTIONS_SHOW'] = array(
	'PARENT' => 'SECTIONS_SETTINGS',
	'NAME' => getMessage('RS_WINN_SIDEBAR_INNER_SECTIONS_SHOW'),
	'TYPE' => 'CHECKBOX',
	'DEFAULT' => 'Y',
	'SORT' => 800
);
...
)
{
	$arTemplateParameters['SIDEBAR_OUTER_SECTION_SHOW'] = [
		'PARENT' => 'LIST_SETTINGS',
		'NAME' => getMessage('RS_WINN_SIDEBAR_OUTER_SECTION_SHOW'),
		'TYPE' => 'CHECKBOX',
		'DEFAULT' => 'Y',
		'SORT' => 800
	];
	$arTemplateParameters['SIDEBAR_INNER_SECTION_SHOW'] = [
		'PARENT' => 'LIST_SETTINGS',
		'NAME' => getMessage('RS_WINN_SIDEBAR_INNER_SECTION_SHOW'),
		'TYPE' => 'CHECKBOX',
		'DEFAULT' => 'Y',
		'SORT' => 800
	];
...
$arTemplateParameters['SIDEBAR_OUTER_PATH'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage('RS_WINN_SIDEBAR_INNER_PATH'),
	'TYPE' => 'STRING',
	'SORT' => 800
);
$arTemplateParameters['SIDEBAR_INNER_PATH'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage('RS_WINN_SIDEBAR_OUTER_PATH'),
	'TYPE' => 'STRING',
	'SORT' => 800
);
*/
...
if (isset($arCurrentValues['LIST_SHOW_VIEWED']) && $arCurrentValues['LIST_SHOW_VIEWED'] === 'Y')
{
	$arTemplateParameters['VIEWED_SECTION_LIST_PAGE_ELEMENT_COUNT'] = array(
		'PARENT' => 'LIST_SETTINGS',
		'NAME' => GetMessage('RS_WINN_VIEWED_SECTION_LIST_PAGE_ELEMENT_COUNT'),
		'TYPE' => 'STRING',
		'DEFAULT' => '4',
	);
}
...
$arTemplateParameters['DETAIL_TAB_PROPERTIES'] = array(
	'PARENT' => 'DETAIL_SETTINGS',
	'NAME' => Loc::getMessage('RS_WINN_DETAIL_TAB_PROPERTIES'),
	'TYPE' => 'LIST',
	'VALUES' => $defaultValue + $arAllPropList,
	'REFRESH' => 'Y',
	'MULTIPLE' => 'Y',
...
$arTemplateParameters['DETAIL_TABS'] = array(
	'PARENT' => 'DETAIL_SETTINGS',
	'NAME' => Loc::getMessage('RS_WINN_DETAIL_TABS'),
	'TYPE' => 'LIST',
...
if (is_array($arCurrentValues['DETAIL_TABS']) && count($arCurrentValues['DETAIL_TABS']) > 0)
{
	...
	$arTemplateParameters['DETAIL_TABS_ORDER'] = array(
		'PARENT' => 'DETAIL_SETTINGS',
		'NAME' => GetMessage('RS_WINN_DETAIL_TABS_ORDER'),
		'TYPE' => 'CUSTOM',
		'JS_FILE' => CatalogSectionComponent::getSettingsScript('/bitrix/components/bitrix/catalog.section', 'dragdrop_order'),
		'JS_EVENT' => 'initDraggableOrderControl',
		'JS_DATA' => Json::encode($selected),
...
$arTemplateParameters['DETAIL_BLOCK_LINES_PROPERTIES'] = array(
	'PARENT' => 'DETAIL_SETTINGS',
	'NAME' => Loc::getMessage('RS_WINN_DETAIL_BLOCK_LINES_PROPERTIES'),
	'TYPE' => 'LIST',
	'VALUES' => $defaultValue + $arAllPropList,
	'REFRESH' => 'Y',
	'MULTIPLE' => 'Y',
...
$arTemplateParameters['DETAIL_BLOCK_LINES'] = array(
	'PARENT' => 'DETAIL_SETTINGS',
	'NAME' => Loc::getMessage('RS_WINN_DETAIL_BLOCK_LINES'),
	'TYPE' => 'LIST',
...
if (is_array($arCurrentValues['DETAIL_BLOCK_LINES']) && count($arCurrentValues['DETAIL_BLOCK_LINES']) > 0)
{
	...
	$arTemplateParameters['DETAIL_BLOCK_LINES_ORDER'] = array(
		'PARENT' => 'DETAIL_SETTINGS',
		'NAME' => GetMessage('RS_WINN_DETAIL_BLOCK_LINES_ORDER'),
		'TYPE' => 'CUSTOM',
		'JS_FILE' => CatalogSectionComponent::getSettingsScript('/bitrix/components/bitrix/catalog.section', 'dragdrop_order'),
		'JS_EVENT' => 'initDraggableOrderControl',
		'JS_DATA' => Json::encode($selected),
...
if (
	is_array($arCurrentValues['DETAIL_TABS']) && in_array('detail', $arCurrentValues['DETAIL_TABS'])
	|| is_array($arCurrentValues['DETAIL_BLOCK_LINES']) && in_array('detail', $arCurrentValues['DETAIL_BLOCK_LINES'])
) {
...
if (
	is_array($arCurrentValues['DETAIL_TABS']) && in_array('props', $arCurrentValues['DETAIL_TABS'])
	|| is_array($arCurrentValues['DETAIL_BLOCK_LINES']) && in_array('props', $arCurrentValues['DETAIL_BLOCK_LINES'])
) {
...
if (
	is_array($arCurrentValues['DETAIL_TABS']) && in_array('comments', $arCurrentValues['DETAIL_TABS'])
	|| is_array($arCurrentValues['DETAIL_BLOCK_LINES']) && in_array('comments', $arCurrentValues['DETAIL_BLOCK_LINES'])
) {
...
if (!empty($arCurrentValues['DETAIL_TAB_PROPERTIES']) || !empty($arCurrentValues['DETAIL_BLOCK_LINES_PROPERTIES']) > 0)
{
	 $arPropertyFileView = array(
		'COL' => Loc::getMessage('RS_WINN_PROPERTY_FILE_VIEW_COL'),
		'LINE' => Loc::getMessage('RS_WINN_PROPERTY_FILE_VIEW_LINE'),
		'IMAGE_COL' => Loc::getMessage('RS_WINN_PROPERTY_FILE_VIEW_IMAGE_COL'),
		'IMAGE_LINE' => Loc::getMessage('RS_WINN_PROPERTY_FILE_VIEW_IMAGE_LINE'),
	 );

	foreach (array_unique((array)$arCurrentValues['DETAIL_TAB_PROPERTIES'] + (array)$arCurrentValues['DETAIL_BLOCK_LINES_PROPERTIES']) as $code)
	{
		...
		if (isset($arLinkElementPropList[$code]))
		{
			$arTemplateParameters['PROPERTY_ELEMENT_LINE_COUNT'] = array(
				'PARENT' => 'DETAIL_SETTINGS',
				'NAME'		=> GetMessage('RS_WINN_PROPERTY_ELEMENT_LINE_COUNT'),
				'TYPE'		=> 'STRING',
				'DEFAULT'	=> 4
			);
		}
...
if (Loader::includeModule('redsign.winn'))
{
	...
	$arTemplateParameters['DETAIL_TEMPLATE'] = array(
		'PARENT' => 'DETAIL_SETTINGS',
		'NAME' => Loc::getMessage('RS_WINN_DETAIL_TEMPLATE'),
		'TYPE' => 'LIST',
...
/*
	...
	else
	{
		...
		$arTemplateParameters['SHOW_SECTIONS_LIST'] = array(
			'PARENT' => 'LIST_SETTINGS',
			'NAME' => GetMessage('RS_WINN_SHOW_SECTIONS_LIST'),
			'TYPE' => 'CHECKBOX',
			'DEFAULT' => 'Y'
		);
	}
...
/*
	$arTemplateParameters['DETAIL_SHOW_CASHBACK'] = array(
		'PARENT' => 'DETAIL_SETTINGS',
		'NAME' => Loc::getMessage('RS_WINN_DETAIL_SHOW_CASHBACK'),
		'TYPE' => 'CHECKBOX',
		'DEFAULT' => 'N',
	);
*/
...
$arTemplateParameters['IBLOCK_ID_LANDING'] = array(
	'PARENT' => 'DETAIL_SETTINGS',
	'NAME' => Loc::getMessage('RS_WINN_IBLOCK_ID_LANDING'),
	'TYPE' => 'LIST',
	'VALUES' => $arIBlock,
	'DEFAULT' => '-',
	'REFRESH' => 'Y',
...
if (!empty($arAllPropListLand))
{
	$arTemplateParameters['PROPERTY_LANDING'] = array(
		'PARENT' => 'DETAIL_SETTINGS',
		'NAME' => Loc::getMessage('RS_WINN_PROPERTY_LANDING'),
		'TYPE' => 'LIST',
	...
	$arTemplateParameters['PROPERTY_LANDING_LINK'] = array(
		'PARENT' => 'DETAIL_SETTINGS',
		'NAME' => Loc::getMessage('RS_WINN_LANDING_LINK'),
		'TYPE' => 'LIST',
		'VALUES' => $defaultValue + $arAllPropList,
...
if ($arCurrentValues['USE_FILTER'] == 'Y')
{
	$arTemplateParameters['FILTER_SCROLL_PROPS'] = array(
		'PARENT' => 'FILTER_SETTINGS',
		'NAME' => getMessage('RS_WINN_FILTER_SCROLL_PROPS'),
		'TYPE' => 'LIST',
		'MULTIPLE' => 'Y',
		'VALUES' => $defaultValue + $arAllPropList,
		'DEFAULT' => '-',
	...
	$arTemplateParameters['FILTER_SEARCH_PROPS'] = array(
		'PARENT' => 'FILTER_SETTINGS',
		'NAME' => Loc::getMessage('RS_WINN_FILTER_SEARCH_PROPS'),
		'TYPE' => 'LIST',
		'MULTIPLE' => 'Y',
		'VALUES' => $defaultValue + $arAllPropList,
		'DEFAULT' => '-',
...
/*
	$arTemplateParameters['FEATURE_FILTER_USER_FIELDS'] = array(
		'PARENT' => 'FILTER_SETTINGS',
		'NAME' => GetMessage('RS_WINN_FEATURE_FILTER_USER_FIELDS'),
		'TYPE' => 'LIST',
		'VALUES' => array_merge($defaultValue, $arProperty_UF),
		'DEFAULT' => '-',
	);
...
if (is_array($arCurrentValues['DETAIL_PRODUCT_INFO_BLOCK']) && in_array('cheaper', $arCurrentValues['DETAIL_PRODUCT_INFO_BLOCK']))
{
	$arTemplateParameters['CHEAPER_FORM_URL'] = array(
		'PARENT' => 'VISUAL',
		'NAME' => Loc::getMessage('RS_WINN_CHEAPER_FORM_URL'),
		'TYPE' => 'STRING',
...
$arTemplateParameters['PRODUCT_DEALS_SHOW'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage('RS_WINN_PRODUCT_DEALS_SHOW'),
	'TYPE' => 'CHECKBOX',
	'DEFAULT' => 'N',
);
...
if (isset($arCurrentValues['PRODUCT_DEALS_SHOW']) && 'Y' == $arCurrentValues['PRODUCT_DEALS_SHOW'])
{
	$arTemplateParameters['PRODUCT_DEALS_USER_FIELDS'] = array(
		'PARENT' => 'VISUAL',
		'NAME' => GetMessage('RS_WINN_PRODUCT_DEALS_USER_FIELDS'),
		'TYPE' => 'LIST',
		'MULTIPLE' => 'N',
		'DEFAULT' => '-',
		'ADDITIONAL_VALUES' => 'Y',
	...
	$arTemplateParameters['PRODUCT_DEALS_PROP'] = array(
		'PARENT' => 'VISUAL',
		'NAME' => Loc::getMessage('RS_WINN_PRODUCT_DEALS_PROP'),
		'TYPE' => 'LIST',
		'VALUES' => $defaultValue + $arAllPropList,
		'DEFAULT' => '-',
	);
...
if (Loader::includeModule('sale'))
{
	$arTemplateParameters['DETAIL_DELIVERY_PAYMENT_INFO'] = array(
		'PARENT' => 'DETAIL_SETTINGS',
		'NAME' => Loc::getMessage('RS_WINN_DETAIL_DELIVERY_PAYMENT_INFO'),
		'TYPE' => 'CHECKBOX',
		'DEFAULT' => 'N',
		'REFRESH' => 'Y',
	);
	...
	if (isset($arCurrentValues['DETAIL_DELIVERY_PAYMENT_INFO']) && 'Y' == $arCurrentValues['DETAIL_DELIVERY_PAYMENT_INFO'])
	{
		$arTemplateParameters['DETAIL_DELIVERY_LINK'] = array(
			'PARENT' => 'DETAIL_SETTINGS',
			'NAME' => Loc::getMessage('RS_WINN_DETAIL_DELIVERY_LINK'),
			'TYPE' => 'STRING',
			'DEFAULT' => '/delivery/',
		);
		$arTemplateParameters['DETAIL_PAYMENT_LINK'] = array(
			'PARENT' => 'DETAIL_SETTINGS',
			'NAME' => Loc::getMessage('RS_WINN_DETAIL_PAYMENT_LINK'),
			'TYPE' => 'STRING',
			'DEFAULT' => '/payment/',
		);
	}
...
if ($arCurrentValues['USE_PRODUCT_QUANTITY'] == 'Y')
{
	$arTemplateParameters['LIST_USE_PRODUCT_QUANTITY'] = array(
		'PARENT' => 'BASKET',
		'NAME' => Loc::getMessage('RS_WINN_LIST_USE_PRODUCT_QUANTITY'),
		'TYPE' => 'CHECKBOX',
		'DEFAULT' => 'N',
		'REFRESH' => 'N',
	);
	...
	$arTemplateParameters['DETAIL_USE_PRODUCT_QUANTITY'] = array(
		'PARENT' => 'BASKET',
		'NAME' => Loc::getMessage('RS_WINN_DETAIL_USE_PRODUCT_QUANTITY'),
		'TYPE' => 'CHECKBOX',
		'DEFAULT' => 'N',
		'REFRESH' => 'N',
	);
...
if (ModuleManager::isModuleInstalled('redsign.devcom'))
{
	$arTemplateParameters['USE_SORTER'] = array(
		'PARENT' => 'PAGER_SETTINGS',
		'NAME' => GetMessage('RS_WINN_USE_SORTER'),
		'TYPE' => 'CHECKBOX',
		'VALUE' => 'Y',
		'REFRESH' => 'Y',
		'DEFAULT' => 'Y',
	...
	if ($arCurrentValues['USE_SORTER'] == 'Y')
	{
		$arTemplateParameters['SORTER_TEMPLATE'] = array(
			'PARENT' => 'PAGER_SETTINGS',
			'NAME' => Loc::getMessage('RS_WINN_SORTER_TEMPLATE'),
			'TYPE' => 'LIST',
...
/*
		...
		else
		{
			$arParams['LIST_ROWS_COUNT'] = array(
				'PARENT' => 'PAGER_SETTINGS',
				'NAME' => GetMessage('RS_WINN_LIST_SHOW_ROWS'),
				'TYPE' => 'STRING',
				'DEFAULT' => 4
			);
		}
