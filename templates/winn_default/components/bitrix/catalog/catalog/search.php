...
*/
	...
	// else
	// {
		// ShowError(getMessage('RS_WINN_BC_CATALOG_SEARCH_NO_RESULT'));
...
$APPLICATION->SetTitle(getMessage('RS_WINN_BC_CATALOG_SEARCH_PAGE_TITLE'));
$APPLICATION->AddChainItem(getMessage('RS_WINN_BC_CATALOG_SEARCH_PAGE_TITLE') , $APPLICATION->GetCurPage());
