...
$MESS["TP_BST_SHOW_INPUT_LABEL"] = "Показывать подпись поля поиска";
$MESS["TP_BST_INPUT_LABEL_TEXT"] = "Подпись поля поиска";
$MESS["TP_BST_INPUT_LABEL_TEXT_DEFAULT"] = "Поиск по сайту";
