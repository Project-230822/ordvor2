...
*/?>
			<li class="page-item page-prev"><a class="page-link" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]+1)?>"><svg class="icon-svg"><use xlink:href="#svg-chevron-left"></use></svg><?=GetMessage('nav_prev')?></a></li>
		<?else:?>
<?/*
			<li class="page-item"><a class="page-link" href="<?=$arResult["sUrlPath"]?><?=$strNavQueryStringFull?>"><?=GetMessage("nav_begin")?></a></li>
*/?>
			<?if ($arResult["NavPageCount"] == ($arResult["NavPageNomer"]+1) ):?>
				<li class="page-item page-prev"><a class="page-link" href="<?=$arResult["sUrlPath"]?><?=$strNavQueryStringFull?>"><svg class="icon-svg"><use xlink:href="#svg-chevron-left"></use></svg><?=GetMessage('nav_prev')?></a></li>
			<?else:?>
				<li class="page-item page-prev"><a class="page-link" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]+1)?>"><svg class="icon-svg"><use xlink:href="#svg-chevron-left"></use></svg><?=GetMessage('nav_prev')?></a></li>
			<?endif?>
		<?endif?>
	...
	<?if ($arResult["NavPageNomer"] > 1):?>
		<li class="page-item page-next"><a class="page-link" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]-1)?>" aria-label="Next">
			<?=GetMessage('nav_next')?><svg class="icon-svg" aria-hidden="true"><use xlink:href="#svg-chevron-right"></use></svg>
        </a></li>
<?/*
...
*/?>
			<li class="page-item page-prev"><a class="page-link" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]-1)?>">
                <svg class="icon-svg" aria-hidden="true"><use xlink:href="#svg-chevron-left"></use></svg><?=GetMessage('nav_prev')?>
            </a></li>
		<?else:?>
<?/*
			<li class="page-item"><a class="page-link" href="<?=$arResult["sUrlPath"]?><?=$strNavQueryStringFull?>"><?=GetMessage("nav_begin")?></a></li>
